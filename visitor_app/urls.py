...
urlpatterns = [
    ...
    path("refund-ticket/<int:order_id>/<int:order_ticket_id>/", payment_views.refund_ticket, name="refund_ticket"),
    path("refund-ticket/<int:order_id>/", payment_views.refund_ticket, name="refund_ticket_legacy"),
