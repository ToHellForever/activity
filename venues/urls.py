...
urlpatterns = [
    ...
    path(
        "save_venue_equipment/", views.save_venue_equipment, name="save_venue_equipment"
    ),
    path(
        "venue/<int:venue_id>/get_equipment_items/",
    ...
    path(
        ...
        views.public_get_equipment_items,
        name="public_get_equipment_items",
    ),
    path(
        "public/save_venue_equipment/",
        views.public_save_venue_equipment,
        name="public_save_venue_equipment",
    ),
    path(
        "send_booking_request/", views.send_booking_request, name="send_booking_request"
    ),
    path(
